  ...
  return (
    <Dialog>
      ...
      <DialogContent className='sm:max-w-[425px]'>
        <DialogHeader>
          <DialogTitle className='font-bold text-2xl'>Создать свой холст</DialogTitle>
          <DialogDescription>
            <div className='mt-4'>
              <p className='text-sm text-gray-500'>Укажите параметры вашего будущего дизайна</p>
              ...
              <div className='mt-6 space-y-4'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div className='flex flex-col gap-2'>
                    <label className='text-sm font-semibold text-gray-700'>Ширина (px)</label>
                    <Input 
                      type="number"
                      placeholder='500' 
                  ...
                  <div className='flex flex-col gap-2'>
                    <label className='text-sm font-semibold text-gray-700'>Высота (px)</label>
                    <Input 
                      type="number"
                      placeholder='500' 
              ...
              <div className='flex justify-end mt-8'>
                ...
                >
                  {loading?<Loader2Icon className='animate-spin'></Loader2Icon>: 'Создать макет'}
                </Button>
              </div>
            </div>
          </DialogDescription>
